...
lr = 0.0005
batch_size = 32
input_dim = 16      # ★実際のデータに合わせてください
embedding_dim = 32  # ★調整可能なハイパーパラメータ

# 1. データセット全体をロード
full_dataset = kICNDataset('/mnt/c/Users/matsu/SICK/pay-10-bucks/kICN_Dataset/histogram_dataset_16bins_64points_noise005_1520.npz')
...
plt.title('16bins_64points_noise005_1520')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.xticks(epoch_range)
plt.grid(True)
plt.legend()
plt.savefig('/mnt/c/Users/matsu/SICK/pay-10-bucks/logs/bins_64points_noise005_1520_loss.png')
plt.show()

torch.save(model.state_dict(), '/mnt/c/Users/matsu/SICK/pay-10-bucks/models/histogram_siamese_model.pth')
print("モデルを '/mnt/c/Users/matsu/SICK/pay-10-bucks/models/histogram_siamese_model.pth' として保存しました。")
# ==============================================================================
# D. 評価フェーズ
# ==============================================================================
print("\n--- モデル評価開始 ---")
...
plt.title('16bins_64points_noise005_768')
plt.xlabel('Euclidean Distance')
plt.ylabel('Frequency')
plt.legend()
plt.grid(True)
plt.savefig('/mnt/c/Users/matsu/SICK/pay-10-bucks/logs/16bins_64points_noise005_768_distribution.png')
plt.show()