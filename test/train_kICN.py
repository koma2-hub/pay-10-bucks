...
# 1. データセット全体をロード
full_dataset = kICNDataset('/mnt/c/Users/matsu/SICK/pay-10-bucks/kICN_Dataset/histogram_dataset_16bins_64points_weaknoise3072.npz')
...
plt.title('16bins_64points_weaknoise3072')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.xticks(epoch_range)
plt.grid(True)
plt.legend()
plt.savefig('/mnt/c/Users/matsu/SICK/pay-10-bucks/logs/16bins_64points_weaknoise3072_loss.png')
plt.show()

torch.save(model.state_dict(), 'siamese_model.pth')
print("モデルを 'siamese_model.pth' として保存しました。")
# ==============================================================================
# D. 評価フェーズ
# ==============================================================================
print("\n--- モデル評価開始 ---")
...
plt.legend()
plt.grid(True)
plt.savefig('/mnt/c/Users/matsu/SICK/pay-10-bucks/logs/16bins_64points_weaknoise3072_distribution.png')
plt.show()